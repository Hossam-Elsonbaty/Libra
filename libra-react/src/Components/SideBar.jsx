  ...
  return (
    ...
    <div className="sideBar">
      ...
      <div className="sideBar-menu">
        ...
        <MenuItem title="الصفحات" icon="fa fa-file" submenuTitles={[{title:"بيانات العميل",navigate:"transaction"},{title:"بيانات جميع العملاء",navigate:"xxx"}]}/>
        ...
        <MenuItem title="التقارير" icon="fa fa-clipboard" submenuTitles={[{title:"التقارير",navigate:"xxx"}]}/>
        <MenuItem title="الاحصائيات" icon="fa fa-signal" submenuTitles={[{title:"الاحصائيات",navigate:"xxx"}]}/>
      </div>
    </div>
    </>
  )
